...
import testImage from "../assets/image/mission.png";
    ...
    <section className="py-12 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row-reverse items-stretch">
          ...
          >
            <div className="relative overflow-hidden h-full min-h-64 md:min-h-80 lg:min-h-96 rounded-tr-[3rem] md:rounded-tr-[5rem] lg:rounded-tr-[6rem]">
              <img
                src={testImage}
                alt={t.aboutMissionTitle}
